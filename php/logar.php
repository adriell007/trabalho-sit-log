...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0) {
        ...
        $sql_code = "SELECT * FROM cadastro email = '$email' AND senha ='$senha'";
...
<div class="container" id="container">
        <div class="form-container sign-up">
            <form action="logar.php" method="post" onsubmit="return validarFormulario_2()">
                <h1 class="texto-l">Cadastre-se</h1><br><br>
        ...
        <div class="form-container sign-in">
            <form action="logar.php" method="post" onsubmit="return validarFormulario()">
                <h1 class="texto-l">faça o seu login</h1><br><br>
        ...
        <div class="toggle-container">
            <div class="toggle">
                ...
                <div class="toggle-panel toggle-right">
                    <h1>Bem-Vindo!</h1>
                    <p>Crie sua conta agora! e receba nossas notificações.</p>
